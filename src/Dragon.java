...
public class Dragon extends Champion implements Serializable
{
     ...
     * @param talks
     */
    public Dragon(String reference ,String ChampionName,int skillLevel,int entryFee,boolean isMa,boolean isF,boolean isMy,boolean talks)
    {
    ...
    Map<String, String> getWeapon() 
    {
        ...
        String toHash = String.valueOf(talks);
        weapon.put("Talks ", toHash);
